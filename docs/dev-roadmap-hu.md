...
**Állapot:** termékterv a 2.0.14 (versionCode 32) után. A fában már benne van a térkép HUD, a GPX 1.1, a skyplot, a magasságprofil, a QNH, a GPS-magasság választás és az OSM fájl/kamera védelem.  
...
A verziószámok **javaslatok**. A 2.0.14 patch maradhat hotfixnek; a következő minor a hullám 1 maradéka.
