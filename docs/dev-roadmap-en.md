...
**Status:** Product plan after 2.0.10 (versionCode 28). The tree already has the map HUD, GPX 1.1, skyplot, elevation profile, QNH, GPS altitude pick, and OSM file/camera guards.  
...
Version numbers are **suggestions**. 2.0.10 can stay a hotfix line; the next minor is the rest of wave 1.
