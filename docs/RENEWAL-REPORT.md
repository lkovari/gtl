...
- **2.0.6** — Map HUD, GPX 1.1, skyplot, elevation profile, QNH, GPS altitude pick, compass MAG/TRUE, OSM file/camera guards, KMZ Start/Pause/Stop on the stored line. Notes: [CHANGELOGS.md](../CHANGELOGS.md).
