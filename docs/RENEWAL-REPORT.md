...
- **2.0.4** — **Use GNSS only**, runner smoothing off, 0.5 m pedestrian duplicate floor, heading from consecutive positions when GPS bearing is 0. How the map line is the stored log: [README.md — How logging works](../README.md#how-logging-works). Notes: [CHANGELOGS.md](../CHANGELOGS.md), [CHANGELOG-2026-09-09.md](CHANGELOG-2026-09-09.md).
