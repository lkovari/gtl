...
| Module    | Role                                                                                                                                                                            |
| --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `:engine` | Pure JVM: GNSS classification, skyplot projection, GPS altitude pick, baro/QNH, Kalman track filter, fix acceptance, speed-adaptive spacing, Douglas–Peucker, track stats, KML/KMZ, GPX 1.1, map HUD visibility, tap straight-line and coordinate labels, Route-tab idle speeds, compass MAG/TRUE heading, elevation series, OSM file/camera/redraw, OSM render-option categories, map-visibility rules, track endpoints, fix-cloud buffer. JUnit tests live here. |
